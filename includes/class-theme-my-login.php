...
class Theme_My_Login extends Theme_My_Login_Abstract {
	...
	public static function default_pages() {
		return apply_filters( 'tml_default_pages', array(
			'login'        => __( 'Iniciar sesión'        , 'theme-my-login' ),
			'logout'       => __( 'Salir de la sesión'       , 'theme-my-login' ),
			'register'     => __( 'Registrarse'      , 'theme-my-login' ),
			'lostpassword' => __( 'Contraseña Perdida' , 'theme-my-login' ),
			'resetpass'    => __( 'Resetear Contraseña', 'theme-my-login' )
		) );
	}
